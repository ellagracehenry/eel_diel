...
################ LOAD IN ######################################
transitions = read.csv("/Users/ellag/Desktop/PhD/academic_projects/eel_diel/data/transitions/transitions_D2_31_05_25_complete.csv", header = FALSE) #load in transitions
